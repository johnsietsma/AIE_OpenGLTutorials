...
void prompt() { std::cout << "Ready? "; char str[99]; std::cin.getline(str,99); }
void separate()  { for (int z=0; z<10; z++) std::cout << "-------"; std::cout << std::endl; }
void separateX() { for (int z=0; z<10; z++) std::cout << "---X---"; std::cout << std::endl; }
void skipline() { char str[99]; std::cin.getline(str,99); }
